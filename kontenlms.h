...
struct KontenLMS {
    ...
    string judulKonten; // Judul konten (digunakan sebagai key pencarian)
    string jenisKonten; // Materi, Quiz, PR, Tugas, Video, Referensi
    int ukuranMB; // Ukuran data dalam satuan MB
};
